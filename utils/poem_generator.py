...
"""
    ...
    poem_type_instructions = {
        ...
        "eminem": "Create a rap poem in the aggressive, technical style of Eminem. Use vivid imagery, emotional punchlines, and complex rhyme schemes. Channel his raw intensity and confessional lyricism while maintaining poetic flow. Incorporate multisyllabic rhymes and rapid-fire delivery in the text.",
        "taylor swift": "Compose a heartfelt, narrative poem in the style of Taylor Swift's songwriting. Focus on relationships, personal reflections, and vivid storytelling. Create emotional moments that feel both intimate and universal, with clever turns of phrase and memorable imagery.",
        "50 cent": "Write a confident, rhythmic poem in the style of 50 Cent. Embody the hustler mentality with bold declarations and street-smart wisdom. Keep the flow tight and the attitude unapologetic, with punchy lines that demand attention.",
        "drake": "Craft a smooth, introspective poem in Drake's emotionally driven style. Blend vulnerability with confidence, creating reflective verses that explore relationships, success, and personal growth. Maintain a melodic flow even in text form.",
        "kendrick lamar": "Compose a socially conscious poem in Kendrick Lamar's layered style. Use complex metaphors, social commentary, and profound insights. Create multiple levels of meaning that reward close reading, with poetic devices that enhance the message.",
        "j. cole": "Write a wise, reflective poem in J. Cole's storytelling style. Focus on relatable life experiences, philosophical musings, and personal growth. Maintain a grounded perspective with clever wordplay and thoughtful observations.",
        "doja cat": "Create a playful, clever poem infused with pop-culture references in Doja Cat's style. Blend humor with wit, and don't shy away from bold, sexy, or quirky imagery. Keep the tone light but the wordplay sharp.",
        "nicki minaj": "Compose a bold, high-energy poem in Nicki Minaj's technical style. Pack it with witty punchlines, complex rhyme schemes, and flamboyant imagery. Showcase versatility in flow while maintaining a confident, in-your-face attitude.",
        "lil wayne": "Write a wordplay-heavy poem in Lil Wayne's punchline-driven style. Pack each line with clever metaphors, unexpected connections, and freestyle-like creativity. Bend language in surprising ways while maintaining rhythmic flow.",
        "elvis presley": "Create a romantic poem with rockabilly charm in Elvis Presley's timeless style. Focus on love, longing, and emotional expression with smooth, melodic phrasing. Capture that classic 50s charm in poetic form.",
        "buddy holly": "Compose an innocent, upbeat poem in Buddy Holly's wholesome Americana style. Keep it short-and-sweet with simple but effective imagery and joyful expressions. Channel that 1950s optimism and charm.",
        "louis armstrong": "Write a soulful, jazzy poem full of wonder and joy in Louis Armstrong's style. Incorporate improvisational flow, warm expressions, and timeless sentiments. Make it swing even on the page.",
